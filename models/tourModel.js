...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      // validate: [validator.isAlpha, 'Tour name must only contain chacracters']
    },
    slug: String,
    duration: {
      type: Number,
    ...
    summary: {
      type: String,
      //Remove white space between last and start of the string
      trim: true,
  ...
  //Make the virtual properties show up in the output even its not store in db
  {
    toJSON: {
      virtuals: true
    },
